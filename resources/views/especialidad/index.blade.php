        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-4 text-right">
                    <a href="{{ url('/especialidad/create') }}" class="btn btn-sm btn-primary">Nuevo Especialidad</a>
                </div>
            </div>
        </div>
        <div class="card-body">   
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                            <form action="{{ url('/especialidad/delete/'.$item->id) }}" method="post">
                                                @csrf
                                                @method('DELETE')
                                                <a href="{{ url('/especialidad/edit/'.$item->id) }}" class="btn btn-sm btn-secondary">Modificar</a>
                                                <br>
